...
HD_PWD='F:/cpu-design/lab2/miniRV_pipeline_axi/miniRV.runs/axi_protocol_converter_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_protocol_converter_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_protocol_converter_1.tcl
