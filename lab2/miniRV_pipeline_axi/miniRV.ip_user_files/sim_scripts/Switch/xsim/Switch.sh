...
#
# Script generated by Vivado on Thu Jul 30 10:58:39 +0800 2026
...
#
# Usage        : Switch.sh
#                Switch.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Switch.sh [-reset_run]
#                Switch.sh [-reset_log]
#                Switch.sh [-help]
#
...
# script info
echo -e "Switch.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Switch.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_31 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Switch xil_defaultlib.Switch xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Switch -key {Behavioral:sim_1:Functional:Switch} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Switch.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Switch.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Switch.sh [-help]\n\
Usage: Switch.sh [-step]\n\
Usage: Switch.sh [-lib_map_path]\n\
Usage: Switch.sh [-reset_run]\n\
Usage: Switch.sh [-reset_log]\n\
Usage: Switch.sh [-keep_index]\n\
Usage: Switch.sh [-noclean_files]\n\n\
