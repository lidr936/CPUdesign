...
#
# Script generated by Vivado on Thu Jul 30 10:59:11 +0800 2026
...
# script info
echo -e "LED.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_31 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot LED xil_defaultlib.LED xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim LED -key {Behavioral:sim_1:Functional:LED} -tclbatch cmd.tcl -log simulate.log
}
