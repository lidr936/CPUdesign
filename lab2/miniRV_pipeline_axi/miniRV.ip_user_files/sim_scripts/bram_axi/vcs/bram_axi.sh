...
#
# Script generated by Vivado on Thu Jul 30 10:45:57 +0800 2026
...
# script info
echo -e "bram_axi.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_axi xil_defaultlib.glbl -o bram_axi_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_axi_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram_axi_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_axi_simv.daidir vcs_lib c.obj)
