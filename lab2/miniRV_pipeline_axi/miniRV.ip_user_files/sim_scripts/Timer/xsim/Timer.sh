...
#
# Script generated by Vivado on Thu Jul 30 11:00:27 +0800 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_31 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Timer xil_defaultlib.Timer xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Timer -key {Behavioral:sim_1:Functional:Timer} -tclbatch cmd.tcl -log simulate.log
}
