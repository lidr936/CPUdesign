...
#
# Script generated by Vivado on Tue Jul 14 16:14:13 +0800 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/cpu-design/lab1/miniRV_basic_ego1/miniRV_basic/miniRV.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
