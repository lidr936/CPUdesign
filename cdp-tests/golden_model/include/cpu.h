...
typedef struct {
    ...
    __uint32_t mem_pc;
    __uint32_t mem_we;
    __uint32_t mem_waddr;
    __uint32_t mem_wdata;
} TRACE;

typedef enum { OP_ADD, OP_SLT, OP_SLTU, OP_AND, OP_OR, OP_XOR, OP_SLL, OP_SRL, OP_SUB, OP_SRA, OP_INVALID, OP_ECALL,
               OP_MUL, OP_MULH, OP_MULHU, OP_DIV, OP_DIVU, OP_REM, OP_REMU } alu_op_t;
