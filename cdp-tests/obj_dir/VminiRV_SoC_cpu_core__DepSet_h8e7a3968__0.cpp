...
VL_INLINE_OPT void VminiRV_SoC_cpu_core___nba_sequent__TOP__miniRV_SoC__U_cpu__U_core__0(VminiRV_SoC_cpu_core* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ __Vdly__fetch_pc;
    __Vdly__fetch_pc = 0;
    CData/*0:0*/ __Vdly__id_ex_mul_started;
    __Vdly__id_ex_mul_started = 0;
    CData/*0:0*/ __Vdly__ex_mem_mem_started;
    __Vdly__ex_mem_mem_started = 0;
    ...
    __Vdly__id_ex_mul_started = vlSelfRef.__PVT__id_ex_mul_started;
    __Vdly__ex_mem_mem_started = vlSelfRef.__PVT__ex_mem_mem_started;
    vlSelfRef.__Vdly__fetch_discard = vlSelfRef.__PVT__fetch_discard;
    vlSelfRef.__Vdly__fetch_req_pc = vlSelfRef.__PVT__fetch_req_pc;
    __Vdly__fetch_pc = vlSelfRef.__PVT__fetch_pc;
    vlSelfRef.__PVT__mem_wb_valid = ((1U & (~ (IData)(vlSymsp->TOP.fpga_rst))) 
                                     && ((1U & (~ (IData)(vlSelfRef.__PVT__pipe_stall))) 
                                         && (IData)(vlSelfRef.__PVT__ex_mem_valid)));
    if (vlSymsp->TOP.fpga_rst) {
        __Vdly__id_ex_mul_started = 0U;
        __Vdly__ex_mem_mem_started = 0U;
        __Vdly__fetch_pc = 0U;
        vlSelfRef.__Vdly__fetch_req_pc = 0U;
        vlSelfRef.__PVT__ex_mem_store_data = 0U;
        ...
        vlSelfRef.__PVT__id_ex_alu_op = 0x1fU;
        vlSelfRef.__PVT__id_ex_is_muldiv = 0U;
        ...
        vlSelfRef.__PVT__id_ex_alub_sel = 0U;
        vlSelfRef.__PVT__ex_mem_ram_wop = 0U;
        vlSelfRef.__PVT__mem_wb_rf_we = 0U;
        vlSelfRef.__PVT__mem_wb_pc = 0U;
        vlSelfRef.__PVT__id_ex_alua_sel = 0U;
        vlSelfRef.__PVT__id_ex_rs1 = 0U;
        vlSelfRef.__PVT__id_ex_rs2 = 0U;
        vlSelfRef.__PVT__id_ex_rs1_data = 0U;
        vlSelfRef.__PVT__id_ex_rs2_data = 0U;
        vlSelfRef.__PVT__id_ex_npc_op = 0U;
        vlSelfRef.__PVT__id_ex_ram_wop = 0U;
        vlSelfRef.__PVT__ex_mem_rf_we = 0U;
        vlSelfRef.__PVT__ex_mem_valid = 0U;
        vlSelfRef.__PVT__id_ex_rf_we = 0U;
        vlSelfRef.__PVT__id_ex_valid = 0U;
        vlSelfRef.__PVT__if_id_valid = 0U;
    } else {
        if (vlSelfRef.__PVT__pipe_stall) {
            if (((IData)(vlSelfRef.__PVT__mul_stall) 
                 & (~ (IData)(vlSelfRef.__PVT__id_ex_mul_started)))) {
                __Vdly__id_ex_mul_started = 1U;
            }
            if (((IData)(vlSelfRef.__PVT__mem_stall) 
                 & (~ (IData)(vlSelfRef.__PVT__ex_mem_mem_started)))) {
                __Vdly__ex_mem_mem_started = 1U;
            }
        } else {
            if ((1U & (~ (IData)(vlSelfRef.__PVT__ex_redirect)))) {
                if ((1U & (~ (IData)(vlSelfRef.__PVT__load_use_stall)))) {
                    __Vdly__id_ex_mul_started = 0U;
                }
            }
            __Vdly__ex_mem_mem_started = 0U;
        }
        if (vlSelfRef.ifetch_req) {
            vlSelfRef.__Vdly__fetch_req_pc = vlSelfRef.__PVT__fetch_pc;
            __Vdly__fetch_pc = ((IData)(4U) + vlSelfRef.__PVT__fetch_pc);
        }
        if (vlSelfRef.__PVT__ex_redirect) {
            __Vdly__fetch_pc = ((1U == (IData)(vlSelfRef.__PVT__id_ex_npc_op))
                                 ? (0xfffffffeU & (vlSelfRef.__PVT__ex_rs1_value 
                                                   + vlSelfRef.__PVT__id_ex_ext))
                                 : (vlSelfRef.__PVT__id_ex_ext 
                                    + vlSelfRef.__PVT__id_ex_pc));
        }
        if ((1U & (~ (IData)(vlSelfRef.__PVT__pipe_stall)))) {
            vlSelfRef.__PVT__ex_mem_store_data = vlSelfRef.__PVT__ex_rs2_value;
            vlSelfRef.__PVT__ex_mem_ram_wop = vlSelfRef.__PVT__id_ex_ram_wop;
            vlSelfRef.__PVT__mem_wb_rf_we = vlSelfRef.__PVT__ex_mem_rf_we;
            vlSelfRef.__PVT__mem_wb_pc = vlSelfRef.__PVT__ex_mem_pc;
            vlSelfRef.__PVT__ex_mem_rf_we = vlSelfRef.__PVT__id_ex_rf_we;
            if ((1U & (~ (IData)(vlSelfRef.__PVT__ex_redirect)))) {
                if ((1U & (~ (IData)(vlSelfRef.__PVT__load_use_stall)))) {
                    vlSelfRef.__PVT__id_ex_alu_op = vlSelfRef.__PVT__id_alu_op;
                    vlSelfRef.__PVT__id_ex_is_muldiv 
                        = (((IData)(vlSelfRef.__PVT__U_controller__DOT__MUL) 
                            | (IData)(vlSelfRef.U_controller__DOT____VdfgRegularize_h2d1dd4ad_0_29)) 
                           | (IData)(vlSelfRef.__PVT__id_is_div));
                    vlSelfRef.__PVT__id_ex_alub_sel 
                        = (1U & (~ ((IData)(vlSelfRef.__PVT__U_controller__DOT__ADD) 
                                    | ((IData)(vlSelfRef.U_controller__DOT____VdfgRegularize_h2d1dd4ad_0_31) 
                                                   ...
                                                   | ((IData)(vlSelfRef.__PVT__U_controller__DOT__SRA) 
                                                      | ((IData)(vlSelfRef.__PVT__U_controller__DOT__OR) 
                                                         | ((IData)(vlSelfRef.__PVT__U_controller__DOT__AND) 
                                                            | ((IData)(vlSelfRef.__PVT__U_controller__DOT__MUL) 
                                                               | ((IData)(vlSelfRef.U_controller__DOT____VdfgRegularize_h2d1dd4ad_0_29) 
                                                                  | ((IData)(vlSelfRef.U_controller__DOT____VdfgRegularize_h2d1dd4ad_0_27) 
                                                                     | ((IData)(vlSelfRef.U_controller__DOT____VdfgRegularize_h2d1dd4ad_0_28) 
                                                                        | (IData)(vlSelfRef.__PVT__U_controller__DOT__NPC_OP_BRA))))))))))))))));
                    vlSelfRef.__PVT__id_ex_alua_sel 
                        = (0x17U == (0x7fU & vlSelfRef.__PVT__if_id_inst));
                    vlSelfRef.__PVT__id_ex_rs1 = (0x1fU 
                                                  & (vlSelfRef.__PVT__if_id_inst 
                                                     >> 0xfU));
                    vlSelfRef.__PVT__id_ex_rs2 = (0x1fU 
                                                  & (vlSelfRef.__PVT__if_id_inst 
                                                     >> 0x14U));
                    vlSelfRef.__PVT__id_ex_rs1_data 
                        = (((IData)(vlSelfRef.__PVT__mem_wb_can_forward) 
                            & ((IData)(vlSelfRef.__PVT__mem_wb_rd) 
                               == (0x1fU & (vlSelfRef.__PVT__if_id_inst 
                                            >> 0xfU))))
                            ? vlSelfRef.__PVT__mem_wb_data
                            : ((0U == (0x1fU & (vlSelfRef.__PVT__if_id_inst 
                                                >> 0xfU)))
                                ? 0U : ((0x1eU >= (0x1fU 
                                                   & ((vlSelfRef.__PVT__if_id_inst 
                                                       >> 0xfU) 
                                        ...
                                        [(0x1fU & (
                                                   ...
                                                   - (IData)(1U)))]
                                         : 0U)));
                    vlSelfRef.__PVT__id_ex_rs2_data 
                        = (((IData)(vlSelfRef.__PVT__mem_wb_can_forward) 
                            & ((IData)(vlSelfRef.__PVT__mem_wb_rd) 
                               == (0x1fU & (vlSelfRef.__PVT__if_id_inst 
                                            >> 0x14U))))
                            ...
                            : ((0U == (0x1fU & (vlSelfRef.__PVT__if_id_inst 
                                ...
                                ? 0U : ((0x1eU >= (0x1fU 
                                        ...
                                        [(0x1fU & (
                                                   ...
                                                   - (IData)(1U)))]
                                         : 0U)));
                    vlSelfRef.__PVT__id_ex_npc_op = 
                        (3U & ((1U & (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__JALR)))) 
                               | ((2U & (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__NPC_OP_BRA)))) 
                                  | (- (IData)((0x6fU 
                                                == 
                                                (0x7fU 
                                                 & vlSelfRef.__PVT__if_id_inst)))))));
                    vlSelfRef.__PVT__id_ex_ram_wop 
                        = (0xfU & ((1U & (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__SB)))) 
                                   | ((3U & (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__SH)))) 
                                      | (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__SW))))));
                    vlSelfRef.__PVT__id_ex_rf_we = 
                        ((((IData)(vlSelfRef.__PVT__U_controller__DOT__ADDI) 
                          ...
                          | ((IData)(vlSelfRef.__PVT__U_controller__DOT__ADD) 
                             | ((IData)(vlSelfRef.U_controller__DOT____VdfgRegularize_h2d1dd4ad_0_31) 
                                | ((IData)(vlSelfRef.__PVT__U_controller__DOT__SLT) 
                                   | ((IData)(vlSelfRef.__PVT__U_controller__DOT__SLTU) 
                                      | ((IData)(vlSelfRef.__PVT__U_controller__DOT__XOR) 
                                               ...
                                               | ((IData)(vlSelfRef.__PVT__U_controller__DOT__OR) 
                                                  | ((IData)(vlSelfRef.__PVT__U_controller__DOT__AND) 
                                                     | ((IData)(vlSelfRef.__PVT__U_controller__DOT__MUL) 
                                                        | ((IData)(vlSelfRef.U_controller__DOT____VdfgRegularize_h2d1dd4ad_0_29) 
                                                           | (IData)(vlSelfRef.__PVT__id_is_div))))))))))))) 
                         | ((IData)(vlSelfRef.__PVT__U_controller__DOT__LB) 
                            | (((IData)(vlSelfRef.__PVT__U_controller__DOT__LH) 
                                | (IData)(vlSelfRef.__PVT__U_controller__DOT__LW)) 
                               | ((IData)(vlSelfRef.U_controller__DOT____VdfgRegularize_h2d1dd4ad_0_33) 
                                  | ((IData)(vlSelfRef.__PVT__U_controller__DOT__EXT_OP_U) 
                                     | (IData)(vlSelfRef.__PVT__U_controller__DOT__WB_OP_PC4))))));
                }
            }
            vlSelfRef.__PVT__ex_mem_valid = vlSelfRef.__PVT__id_ex_valid;
            vlSelfRef.__PVT__id_ex_valid = ((1U & (~ (IData)(vlSelfRef.__PVT__ex_redirect))) 
                                            && ((1U 
                                                 & (~ (IData)(vlSelfRef.__PVT__load_use_stall))) 
                                                && (IData)(vlSelfRef.__PVT__if_id_valid)));
            if (vlSelfRef.__PVT__ex_redirect) {
                vlSelfRef.__PVT__if_id_valid = 0U;
            } else if ((1U & (~ (IData)(vlSelfRef.__PVT__load_use_stall)))) {
                vlSelfRef.__PVT__if_id_valid = vlSelfRef.__PVT__fetch_buf_valid;
            }
        }
        if (((((IData)(vlSelfRef.__PVT__U_alu__DOT__mul_flag) 
               | (0x12U == (IData)(vlSelfRef.__PVT__ex_alu_op))) 
            ...
            vlSelfRef.__PVT__U_alu__DOT__div_zero_r 
                = (0U == vlSelfRef.__PVT__ex_alu_b);
            vlSelfRef.__PVT__U_alu__DOT__a_r = vlSelfRef.__PVT__ex_alu_a;
            vlSelfRef.__PVT__U_alu__DOT__rem_neg_r 
                = (vlSelfRef.__PVT__ex_alu_a >> 0x1fU);
            vlSelfRef.__PVT__U_alu__DOT__op_r = vlSelfRef.__PVT__ex_alu_op;
            vlSelfRef.__PVT__U_alu__DOT__div_neg_r 
                = ((vlSelfRef.__PVT__ex_alu_a ^ vlSelfRef.__PVT__ex_alu_b) 
                   >> 0x1fU);
            vlSelfRef.__PVT__U_alu__DOT__div_overflow_r 
                = ((0x80000000U == vlSelfRef.__PVT__ex_alu_a) 
                   & (0xffffffffU == vlSelfRef.__PVT__ex_alu_b));
        } else if ((1U & (~ (IData)(vlSelfRef.__PVT__ex_alu_busy)))) {
            vlSelfRef.__PVT__U_alu__DOT__op_r = 0x1fU;
        }
        ...
        if (((0x12U == (IData)(vlSelfRef.__PVT__ex_alu_op)) 
        ...
        if (((IData)(vlSelfRef.__PVT__U_alu__DOT__divu_flag) 
            ...
            if ((0U == vlSelfRef.__PVT__ex_alu_b)) {
    ...
    vlSelfRef.__PVT__id_ex_mul_started = __Vdly__id_ex_mul_started;
    vlSelfRef.__PVT__ex_mem_mem_started = __Vdly__ex_mem_mem_started;
    vlSelfRef.__PVT__fetch_pc = __Vdly__fetch_pc;
...
VL_INLINE_OPT void VminiRV_SoC_cpu_core___nba_sequent__TOP__miniRV_SoC__U_cpu__U_core__2(VminiRV_SoC_cpu_core* vlSelf) {
    ...
    if (vlSymsp->TOP.fpga_rst) {
        vlSelfRef.__PVT__mem_wb_rd = 0U;
        vlSelfRef.__PVT__mem_wb_data = 0U;
        ...
        vlSelfRef.__PVT__id_ex_ext = 0U;
        vlSelfRef.__PVT__id_ex_ram_rop = 0U;
        vlSelfRef.__PVT__id_ex_pc = 0U;
        vlSelfRef.__PVT__id_ex_rf_wsel = 0U;
        vlSelfRef.__PVT__if_id_pc = 0U;
        vlSelfRef.__PVT__if_id_inst = 0x13U;
        vlSelfRef.__Vdly__fetch_discard = 0U;
        vlSelfRef.__PVT__fetch_buf_valid = 0U;
        vlSelfRef.__PVT__fetch_buf_pc = 0U;
        vlSelfRef.__PVT__fetch_buf_inst = 0x13U;
        vlSelfRef.__PVT__fetch_wait = 0U;
    } else {
        if ((1U & (~ (IData)(vlSelfRef.__PVT__pipe_stall)))) {
            vlSelfRef.__PVT__mem_wb_rd = vlSelfRef.__PVT__ex_mem_rd;
            vlSelfRef.__PVT__mem_wb_data = ((1U == (IData)(vlSelfRef.__PVT__ex_mem_rf_wsel))
                                             ? ((4U 
                                                 & (IData)(vlSelfRef.__PVT__ex_mem_ram_rop))
                                                 ? 
                                                ((2U 
                                                  & (IData)(vlSelfRef.__PVT__ex_mem_ram_rop))
                                                  ? vlSelfRef.__PVT__U_mext__DOT__real_din
                                                  : 
                                                 ((1U 
                                                   & (IData)(vlSelfRef.__PVT__ex_mem_ram_rop))
                                                   ? 
                                                ...
                                                ((2U 
                                                 ...
                                                 ((1U 
                                                  ...
                                                  : vlSelfRef.__PVT__U_mext__DOT__real_din))
                                             : ((2U 
                                                 == (IData)(vlSelfRef.__PVT__ex_mem_rf_wsel))
                                                 ? 
                                                ((IData)(4U) 
                                                 + vlSelfRef.__PVT__ex_mem_pc)
                                                 : 
                                                ((3U 
                                                  == (IData)(vlSelfRef.__PVT__ex_mem_rf_wsel))
            ...
            vlSelfRef.__PVT__ex_mem_ext = vlSelfRef.__PVT__id_ex_ext;
            vlSelfRef.__PVT__ex_mem_ram_rop = vlSelfRef.__PVT__id_ex_ram_rop;
            vlSelfRef.__PVT__ex_mem_pc = vlSelfRef.__PVT__id_ex_pc;
            vlSelfRef.__PVT__ex_mem_rf_wsel = vlSelfRef.__PVT__id_ex_rf_wsel;
            if ((1U & (~ (IData)(vlSelfRef.__PVT__ex_redirect)))) {
                if ((1U & (~ (IData)(vlSelfRef.__PVT__load_use_stall)))) {
                    vlSelfRef.__PVT__id_ex_rd = (0x1fU 
                                                 & (vlSelfRef.__PVT__if_id_inst 
                                                    >> 7U));
                    vlSelfRef.__PVT__id_ex_ext = vlSelfRef.__PVT__id_ext;
                    vlSelfRef.__PVT__id_ex_ram_rop 
                        = ((2U & (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__LB)))) 
                           | ((3U & (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__LBU)))) 
                              | ((4U & (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__LH)))) 
                                 | ((5U & (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__LHU)))) 
                                    | (1U & (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__LW))))))));
                    vlSelfRef.__PVT__id_ex_pc = vlSelfRef.__PVT__if_id_pc;
                    vlSelfRef.__PVT__id_ex_rf_wsel 
                        = (3U & ((1U & (- (IData)((
                                                   ((IData)(vlSelfRef.__PVT__U_controller__DOT__LB) 
                                                    | (IData)(vlSelfRef.__PVT__U_controller__DOT__LH)) 
                                                   | ((IData)(vlSelfRef.__PVT__U_controller__DOT__LW) 
                                                      | (IData)(vlSelfRef.U_controller__DOT____VdfgRegularize_h2d1dd4ad_0_33)))))) 
                                 | ((2U & (- (IData)((IData)(vlSelfRef.__PVT__U_controller__DOT__WB_OP_PC4)))) 
                                    | (- (IData)((0x37U 
                                                  == 
                                                  (0x7fU 
                                                   & vlSelfRef.__PVT__if_id_inst)))))));
                    vlSelfRef.__PVT__if_id_pc = vlSelfRef.__PVT__fetch_buf_pc;
                    vlSelfRef.__PVT__if_id_inst = vlSelfRef.__PVT__fetch_buf_inst;
                }
            }
        }
        if (vlSelfRef.ifetch_valid) {
            if ((1U & ((~ (IData)(vlSelfRef.__PVT__fetch_discard)) 
                       & (~ (IData)(vlSelfRef.__PVT__ex_redirect))))) {
                vlSelfRef.__PVT__fetch_buf_valid = 1U;
                vlSelfRef.__PVT__fetch_buf_pc = vlSelfRef.__PVT__fetch_req_pc;
                vlSelfRef.__PVT__fetch_buf_inst = vlSymsp->TOP__miniRV_SoC__U_cpu.__PVT__ic2cpu_inst;
            } else {
                vlSelfRef.__PVT__fetch_buf_valid = 0U;
                vlSelfRef.__Vdly__fetch_discard = 0U;
            }
        }
        if (vlSelfRef.__PVT__take_fetch_buf) {
            vlSelfRef.__PVT__fetch_buf_valid = 0U;
        }
        if (vlSelfRef.__PVT__ex_redirect) {
            vlSelfRef.__PVT__fetch_buf_valid = 0U;
            vlSelfRef.__Vdly__fetch_discard = ((IData)(vlSelfRef.__PVT__fetch_wait) 
                                               & (~ (IData)(vlSelfRef.ifetch_valid)));
        }
        if (vlSelfRef.ifetch_req) {
            vlSelfRef.__PVT__fetch_wait = 1U;
        }
        if (vlSelfRef.ifetch_valid) {
            vlSelfRef.__PVT__fetch_wait = 0U;
        }
    ...
    vlSelfRef.__PVT__U_controller__DOT__DIVU = ((IData)(U_controller__DOT____VdfgRegularize_h2d1dd4ad_0_17) 
                                                & (1U 
                                                   ...
                                                   (vlSelfRef.__PVT__if_id_inst 
                                                    >> 0x19U)));
    vlSelfRef.__PVT__fetch_req_pc = vlSelfRef.__Vdly__fetch_req_pc;
    vlSelfRef.__PVT__fetch_discard = vlSelfRef.__Vdly__fetch_discard;
...
VL_INLINE_OPT void VminiRV_SoC_cpu_core___nba_sequent__TOP__miniRV_SoC__U_cpu__U_core__3(VminiRV_SoC_cpu_core* vlSelf) {
    ...
    } else if ((1U & (~ (IData)(vlSelfRef.__PVT__pipe_stall)))) {
        vlSelfRef.__PVT__ex_mem_alu_c = vlSelfRef.__PVT__ex_alu_c;
    }
